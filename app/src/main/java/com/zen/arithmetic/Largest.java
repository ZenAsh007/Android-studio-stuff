        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    if(a>b)
                    {
                        Toast.makeText(getApplicationContext(), "Largest Number is: " + a, Toast.LENGTH_LONG).show();
                    }
                    else
                    {
                        Toast.makeText(getApplicationContext(), "Largest Number is: " + b, Toast.LENGTH_LONG).show();
                    }
